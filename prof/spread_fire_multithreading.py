...
def spread_one_fire(space_time_cubes, cube_shape, cube_resolution, ignited_cell,
...
def main(num_threads, num_jobs):
    ...
    #============================================================================================
    # Create a dictionary of shared arrays (using constant arrays for this example)
    #============================================================================================
    ...
    #============================================================================================
    # Create an input dictionary of SpaceTimeCubes from the shared arrays
    #============================================================================================
    ...
    #============================================================================================
    # Collect the inputs into a tuple to be shared with the child threads
    #============================================================================================
    ...
    #============================================================================================
    # Run multiple fires in parallel in a thread pool
    #============================================================================================

    print(f"Starting ThreadPool with {num_threads} Threads...")

    with ThreadPoolExecutor(max_workers=num_threads) as pool:
        print(f"Submitting {num_jobs} Parallel Jobs...")
        futures_to_jobs = {pool.submit(spread_one_fire, *input_args): i for i in range(num_jobs)}
        for future in as_completed(futures_to_jobs):
            job_id = futures_to_jobs[future]
            print(f"\nResults of Fire {job_id + 1}")
            pprint(future.result(), sort_dicts=False)
...
if __name__ == "__main__":
    ...
    if args.threads and args.jobs:
        main(num_threads=args.threads, num_jobs=args.jobs)
    else:
        parser.print_help()
