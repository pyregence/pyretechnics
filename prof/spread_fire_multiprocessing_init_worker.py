...
def attach_shared_array(shared_array_spec):
    shared_memory = SharedMemory(name=shared_array_spec["name"])
    shared_array  = np.ndarray(shared_array_spec["shape"],
                               dtype=shared_array_spec["dtype"],
...
def init_worker(shared_array_specs, cube_shape):
    #============================================================================================
    # Declare global variables
    #============================================================================================
    global shared_arrays
    global space_time_cubes

    #============================================================================================
    # Report the current process and thread
    #============================================================================================
    ...
    #============================================================================================
    # Attach to the shared memory arrays specified in shared_array_specs
    #============================================================================================

    shared_arrays = {name: attach_shared_array(shared_array_spec)
                     for (name, shared_array_spec) in shared_array_specs.items()}
...
def spread_one_fire(cube_shape, cube_resolution, ignited_cell,
    ...
    #============================================================================================
    # Detach from the shared memory arrays specified in shared_arrays
    #============================================================================================

    for shared_array in shared_arrays.values():
...
def main(num_cores, num_jobs):
    try:
        ...
        with mp.Pool(processes=num_cores,
                     ...
                     initargs=(shared_array_specs, cube_shape)) as pool:
        ...
        #============================================================================================
        # Detach from the shared memory arrays specified in shared_arrays and free their memory
        #============================================================================================

        for shared_array in shared_arrays.values():
            shared_array["memory"].close()
            shared_array["memory"].unlink()
