...
def spread_one_fire(_i, shared_array_specs, cube_shape, cube_resolution, ignited_cell,
...
def main(num_cores, num_jobs):
    try:
        ...
        #============================================================================================
        # Run multiple fires in parallel using dask
        #============================================================================================
        ...
        futures = [client.submit(spread_one_fire, i, *input_args) for i in range(num_jobs)]
