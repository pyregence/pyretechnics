...
needed to weave, tangle, detangle, test, build, and install this
...
See section [[Space-Time Cube Constructors]] for implementation details.
...
resolution. See section [[Space-Time Cube Constructors]] for
