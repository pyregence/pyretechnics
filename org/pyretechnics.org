...
from pyretechnics_test.test_burn_cells import test_burn_all_cells

worcester = test_burn_all_cells()
#+end_src

#+name: savefig
#+begin_src python :session view-worcester-layers :var title="" layer="" units="" colors="" :results value
...
#+begin_src python :session view-worcester-layers :noweb eval :results value file link :exports results
'<<savefig(title="Max Spread Rate", layer="max_spread_rate", units="m/min", colors="hot")>>'
#+end_src

#+RESULTS:
[[file:pics/worcester_max_spread_rate.png]]
...
#+RESULTS:
[[file:pics/worcester_max_spread_direction.png]]
...
#+RESULTS:
[[file:pics/worcester_max_fire_line_intensity.png]]
...
#+RESULTS:
[[file:pics/worcester_max_flame_length.png]]
...
#+RESULTS:
[[file:pics/worcester_fire_type.png]]
...
#+RESULTS:
[[file:pics/worcester_eccentricity.png]]
