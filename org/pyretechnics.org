...
** Input Loading Functions for Arrays
...
#+name: array-grid3d-class
#+begin_src python :tangle ../src/pyretechnics/array_grid3d.py
...
class ArrayGrid3D:
    ...
    def __init__(self, base, t, y, x):
        # TODO: Ensure that t, y, and x are positive integers
        self.ndim = 3
        self.size = t * y * x
        self.shape = (t, y, x)
        self.base = base
        ...
        # 1D: Time-Series Input
            ...
            t0 = len(base)
            t_repetitions = t / t0
            # TODO: Ensure that t_repetitions is an integer or throw an error
            # Repeat (t0) -> (t)
        ...
        # 2D: Spatial Input
            ...
            y_repetitions = y / y0
            x_repetitions = x / x0
            # TODO: Ensure that y_repetitions and x_repetitions are integers or throw an error
            # Repeat (y0,x0) -> (y,x)
        ...
        # 3D: Spatio-Temporal Input
            ...
            y_repetitions = y / y0
            x_repetitions = x / x0
            # TODO: Ensure that t_repetitions, y_repetitions, and x_repetitions are integers or throw an error
