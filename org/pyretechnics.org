...
*** Arrays -> Space-Time Cubes (Fast, Flexible, Memory Inefficient)
...
*** Arrays -> Space-Time Cubes (Less Fast, Less Flexible, Memory Efficient)
...
*** Lazy Arrays -> Space-Time Cubes (Slower, Less Flexible, Memory Efficient)
