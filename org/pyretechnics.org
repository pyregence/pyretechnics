...
Chris Lautenberger's ELMFire model\cite{?}, a continuous field called
\phi fills the simulation space and is used to track the progression
of the fire front through space and time. Within Pyretechnics, the
\phi field is discretized into grid cells with the following values:

- -1 :: cells that have already been burned and are inside the fire perimeter
- 0 :: cells that are currently burning and coincide with the fire perimeter
- 1 :: cells that have not been burned and are outside the fire perimeter

At the start of the simulation, the \phi grid cells are initialized so
as to identify the actively burning fire perimeter. If a point fire is
being simulated, then a single \phi cell will be set to 0 and the
remaining cells will have the value 1.
...
\begin{align*}
# TODO: Insert normal vector and gradient formulas from https://elmfire.io/tech_ref.html
\end{align*}
...
\begin{align*}
# TODO: Insert spatial gradient formulas from https://elmfire.io/tech_ref.html
\end{align*}
...
\phi field at any location on the grid to compute the fire front
...
angle \theta (measured clockwise from North) to which the normal
vector points:

\begin{align*}
# TODO: Insert normal vector theta formulas from https://elmfire.io/tech_ref.html
\end{align*}
...
spread rate in this direction by simply calculating the dot product of
the normal vector with the maximum spread rate vector calculated for
each cell.
...
\begin{align*}
# TODO: Insert main hyperbolic differential equation for \phi from https://elmfire.io/tech_ref.html
\end{align*}
...
\begin{align*}
# TODO: Insert r and B(r) formulas from https://elmfire.io/tech_ref.html
\end{align*}
...
derivatives of the \phi field as follows:

\begin{align*}
# TODO: Insert sig_phi_sig_x and sig_phi_sig_y formulas from https://elmfire.io/tech_ref.html
\end{align*}

#+name: sig_phi_partial_derivatives
#+begin_src python :tangle ../src/pyretechnics/eulerian_level_set.py
...
\begin{align*}
# TODO: Insert phi_east formulas from https://elmfire.io/tech_ref.html
\end{align*}
...
\begin{align*}
# TODO: Insert phi_west formulas from https://elmfire.io/tech_ref.html
\end{align*}
...
\begin{align*}
# TODO: Insert phi_north formulas from https://elmfire.io/tech_ref.html
\end{align*}
...
\begin{align*}
# TODO: Insert phi_south formulas from https://elmfire.io/tech_ref.html
\end{align*}
...
Now that the various spatial partial derivatives have been calculated,
we can march the \phi field solution forward in time using a second
order Runge Kutta method as follows:

\begin{align*}
# TODO: Insert phi_* and phi_t+dt formulas from https://elmfire.io/tech_ref.html
\end{align*}
