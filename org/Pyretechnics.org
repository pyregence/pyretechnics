...
#+begin_src python :tangle ../src/pyretechnics/surface_fire.py
from conversion import deg2rad, rad2deg, fpm2mph
...
def surface_length_to_width_ratio(effective_wind_speed):
    ...
    L/W = 1 + 0.25 * Ueff_mph
    """
    effective_wind_speed_mph = fpm2mph(effective_wind_speed)
...
from conversion import ft2m, dec2percent, Btu_ft_s2kW_m
...
def van_wagner_crown_fire_initiation(canopy_cover, canopy_base_height, foliar_moisture, fire_line_intensity):
    ...
    return van_wagner_crown_fire_initiation_metric(canopy_cover,
                                                   ft2m(canopy_base_height),
                                                   dec2percent(foliar_moisture),
                                                   Btu_ft_s2kW_m(fire_line_intensity))
#+end_src
...
#+begin_src python :tangle ../src/pyretechnics/crown_fire.py
from convert import m2ft, mph2km_hr, wind_speed_20ft2wind_speed_10m, lb_ft32kg_m3, dec2percent
from math import exp
...
def cruz_crown_fire_spread(wind_speed_20ft, crown_bulk_density, estimated_fine_fuel_moisture):
    ...
    return m2ft(
        cruz_crown_fire_spread_metric(
            wind_speed_20ft2wind_speed_10m(mph2km_hr(wind_speed_20ft)),
            lb_ft32kg_m3(crown_bulk_density),
            dec2percent(estimated_fine_fuel_moisture)))
#+end_src
...
#+attr_latex: :align |l|l|l|r|r|r|l|l|l| :font \small
|---------------------+--------+------------------------------------------+-----+------+--------+---------------+-------+-----------+-----------|
...
#+name: load-landfire
#+begin_src python :tangle ../test/pyretechnics/load_landfire.py
import rasterio
...
# NOTE: rasterio.open can also load chunks of a raster file: https://pypi.org/project/rasterio/
...
# NOTE: This does not use the lazy chunking, multi-resolution functions defined earlier.
