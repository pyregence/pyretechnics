...
magnitude.\citep{Peterson2011,Peterson2009,Rothermel1983}
...
\begin{align*}
  \frac{L}{W} &= 1 + 0.002840909 \, U_{\textrm{eff}} \\
...
in units of hr/mi, so this was converted to match Pyretechnic's use of
