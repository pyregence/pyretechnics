...
def calc_crown_fire_behavior_max(canopy_height, canopy_base_height, canopy_bulk_density, heat_of_combustion,
    ...
    return a dictionary containing these keys:
    - max_spread_type        :: "passive" or "active"
    ...
    return {
        "max_spread_type"       : spread_info["spread_type"],
...
def calc_crown_fire_behavior_in_direction(crown_fire_max, spread_direction):
    ...
    max_spread_type        = crown_fire_max["max_spread_type"]
...
def calc_combined_fire_behavior_in_direction(surface_fire_max, crown_fire_max, spread_direction):
    ...
    return a dictionary containing these keys:
    - spread_type        :: "surface", "passive", or "active"
    - spread_rate        :: m/min
    - fireline_intensity :: kW/m
    """
    ...
    crown_spread_type        = crown_fire_behavior["spread_type"]        # "passive" or "active"
