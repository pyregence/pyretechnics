...
PyDoc_STRVAR(__pyx_doc_15compute_memview_compute, "\n    This function must implement the formula\n    np.clip(array_1, 2, 10) * a + array_2 * b + c\n\n    array_1 and array_2 are 2D.\n    ");
static PyMethodDef __pyx_mdef_15compute_memview_1compute = {"compute", (PyCFunction)(void*)(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_15compute_memview_1compute, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_15compute_memview_compute};
static PyObject *__pyx_pw_15compute_memview_1compute(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("compute (wrapper)", 0);
  {
    ...
    __pyx_v_array_1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_array_1.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_array_2 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_array_2.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_a = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_a == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_b == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_c = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_c == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
 ...
 *     cdef int tmp
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(__pyx_v_result, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 25, __pyx_L1_error)
 ...
 */
      ...
      __pyx_t_15 = __pyx_f_15compute_memview_clip((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_array_1.data + __pyx_t_13 * __pyx_v_array_1.strides[0]) ) + __pyx_t_14 * __pyx_v_array_1.strides[1]) ))), 2, 10); if (unlikely(__pyx_t_15 == ((int)-1) && PyErr_Occurred())) __PYX_ERR(0, 32, __pyx_L1_error)
 ...
 *     This function must implement the formula
 */
  __pyx_tuple__20 = PyTuple_Pack(12, __pyx_n_s_array_1, __pyx_n_s_array_2, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_c, __pyx_n_s_x_max, __pyx_n_s_y_max, __pyx_n_s_result, __pyx_n_s_result_view, __pyx_n_s_tmp, __pyx_n_s_x, __pyx_n_s_y); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(5, 0, 0, 12, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_compute_memview_pyx, __pyx_n_s_compute, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  __pyx_t_1 = PyModule_Create(&__pyx_moduledef); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to compute_memview pseudovariable */
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_intc); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_DTYPE, __pyx_t_4) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 *     This function must implement the formula
 */
  __pyx_t_4 = __Pyx_CyFunction_New(&__pyx_mdef_15compute_memview_1compute, 0, __pyx_n_s_compute, NULL, __pyx_n_s_compute_memview, __pyx_d, ((PyObject *)__pyx_codeobj__21)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_compute, __pyx_t_4) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
