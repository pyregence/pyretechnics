...
cdef float dot_2d(vec_xy vector1, vec_xy vector2)
cdef float dot_3d(vec_xyz vector1, vec_xyz vector2)
...
cdef float vector_magnitude_2d(vec_xy vector)
cdef float vector_magnitude_3d(vec_xyz vector)
cdef vec_xy as_unit_vector_2d(vec_xy vector)
cdef vec_xyz as_unit_vector_3d(vec_xyz vector)
...
cdef vec_xyz get_slope_normal_vector(vec_xy elevation_gradient)
cdef vec_xyz cross_3d(vec_xyz vector1, vec_xyz vector2)
